...
5. Find the **Upload Plugin** section.
6. Click on “Choose File” and select the `.hpi` file you downloaded.
7. Click **Upload**. Jenkins will install the plugin.
8. Restart Jenkins to activate the buildstash-plugin.

## 🔧 Using the Plugin
Once the installation is complete, you can start using the buildstash-plugin.

1. Go to your Jenkins job configuration.
2. Add a new step for the buildstash-plugin.
3. Fill in the required fields to upload your build artifacts.
